...
<body>
    <header class="bg-blue-500 py-4">
        <div class="container mx-auto flex items-center justify-between px-6">
            ...
            <div class="flex space-x-3">
                ...
                <a href="#" class="bg-white text-blue-600 hover:bg-gray-200 px-4 py-2 rounded-md text-lg shadow">Regresar al Menú</a>
    ...
    @yield('D_historialcontent')
    @yield('D_reservacontent')
