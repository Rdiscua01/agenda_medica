...
<body class="bg-gray-50"> 
    ...
    <main class="py-16 px-4 text-center">
        ...
        <!-- IMG CLINICA -->
        <div class="mt-8">
            <img src="{{ asset('imagenes/clinica.jpg') }}" alt="Clínica" class="w-2xs mx-auto rounded-lg shadow-lg">
        </div>
        ...
        <div class="mt-10 flex items-center justify-center max-w-5xl mx-auto p-6">
            <!-- IMG MEDICO -->
            <div class="w-1/2">
                <img src="{{ asset('imagenes/doc text.jpg') }}" alt="Imagen" class="w-full h-auto rounded-lg object-cover">
            </div>
